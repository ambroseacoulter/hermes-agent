...
| 💬 **[Messaging Gateway](/docs/user-guide/messaging)** | Set up Telegram, Discord, Slack, WhatsApp, Signal, Sendblue, SMS, and more |
...
- **Lives where you do** — CLI, Telegram, Discord, Slack, WhatsApp, Signal, Sendblue, SMS, Email, and more from one gateway
