...
_PLATFORMS = [
    ...
    },
    {
        ...
        "vars": [
            ...
            {"name": "SENDBLUE_ALLOWED_USERS", "prompt": "Allowed phone numbers or iMessage emails (comma-separated)", "password": False,
             "is_allowlist": True,
             "help": "Only messages from these Sendblue users will be processed. Supports E.164 numbers and iMessage email handles."},
            {"name": "SENDBLUE_HOME_CHANNEL", "prompt": "Home channel phone number, iMessage email, or group_id (for cron/notification delivery, or empty)", "password": False,
